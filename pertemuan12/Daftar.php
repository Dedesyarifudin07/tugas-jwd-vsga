...
if (isset($_POST["submit"])) {
    if (tambah($_POST) > 0) {
        ...
        echo "<script>
        alert('Maaf Data anda Gagal di tambahkan')
        </script>";
    }
}
...
<body>
    ...
    <form class="w-50 m-auto" action="" method="post">
        ...
        <div class="mb-3 mx-5 sekolah">
            ...
            <input type="text" class="form-control" id="sekolah" name="asal_sekolah" placeholder="asal sekolah">
        </div>
        <button type="submit" class="btn btn-primary  mx-5 text-center" name="submit">Daftar</button>
